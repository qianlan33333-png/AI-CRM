"""Authorize the exact 2026-07-28 private-message contact-absence history.

Revision ID: 0155_private_message_contact_absence_ack_scope
Revises: 0154_internal_event_occurred_index
"""
...
revision = "0155_private_message_contact_absence_ack_scope"
down_revision = "0154_internal_event_occurred_index"
branch_labels = None
depends_on = None
        ...
        ADD CONSTRAINT ck_queue_terminal_ack_error CHECK (
            ...
            OR (
                acknowledgement_type =
                    'production_private_message_contact_absence_20260728_no_replay'
                AND error_code = 'external_contact_relationship_absent'
                AND graph_id IS NULL
            )
        )
        """
...
def downgrade() -> None:
    ...
    # must retain a schema that can continue to read the immutable rows.
    pass
