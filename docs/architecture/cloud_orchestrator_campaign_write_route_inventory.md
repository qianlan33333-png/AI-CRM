...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `/admin/cloud-orchestrator/campaigns` | `aicrm_next/frontend_compat/templates/admin_console/cloud_campaigns_workspace.html` | workspace page | page route | GET | `aicrm_next.extensions.growth.cloud_orchestrator.api.admin_cloud_campaigns` | n/a | none | page over locked Next read APIs plus enabled write controls | page 200, non-empty |
