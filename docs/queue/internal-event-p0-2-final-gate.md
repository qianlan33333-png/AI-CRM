...
| External push outbox worker | `aicrm_next/platform/external_push/service.py` | `old_external_push_outbox_worker` |
| External push retry/test | `aicrm_next/platform/external_push/service.py`, `aicrm_next/extensions/commerce/commerce/external_push_admin.py` | `old_external_push_delivery_retry` |
| Admin deferred jobs runner | `aicrm_next/platform/admin_jobs/application.py` | `old_admin_jobs_deferred_run` |
| Admin webhook retry disabled path | `aicrm_next/platform/admin_jobs/routes.py`, `application.py` | `old_customer_webhook_delivery_retry` |
| Broadcast Feishu report | `aicrm_next/platform/admin_jobs/notification_settings.py` | `old_broadcast_jobs_feishu_hourly_report` |
...
| Broadcast approve/cancel control-plane | `aicrm_next/platform/admin_jobs/application.py` | `old_broadcast_jobs_direct_approve_cancel` |
...
- Capability owner: `aicrm_next/platform/platform_foundation/internal_events`,
