...
def build_external_effect_completed_event(
    *,
    ...
    return InternalEventCreateRequest(
        ...
        source_module="aicrm_next.platform.platform_foundation.external_effects",
...
def _load_canonical_completion(
    ...
    *,
    ...
    from aicrm_next.platform.platform_foundation.internal_events.models import InternalEventConsumerResult
