...
CAPABILITY_SPECS: tuple[CapabilitySpec, ...] = (
    ...
    _spec(
        ...
        current_contexts=("automation_engine", "ops_enrollment"),
    ...
    _spec(
        ...
        current_contexts=("admin_shell", "frontend_compat", "navigation_target"),
    ...
    _spec(
        ...
        event_prefixes=("ai_audience.", "ai_campaign."),
        effect_types=("ai_assist.campaign.message.loopback", "ai_assist.campaign.message.plan"),
