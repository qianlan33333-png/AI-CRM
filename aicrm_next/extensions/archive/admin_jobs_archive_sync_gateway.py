...
from aicrm_next.extensions.archive.message_archive.repo import build_archive_sync_repository
from aicrm_next.extensions.archive.message_archive.sync_service import execute_archive_sync as _execute_archive_sync
    ...
    return enqueue_transactional_internal_event_outbox(
        ...
        InternalEventCreateRequest(
            ...
            context=CommandContext(
                ...
                actor_type="system",
                source_route="aicrm_next.extensions.archive.admin_jobs_archive_sync_gateway",
            ),
