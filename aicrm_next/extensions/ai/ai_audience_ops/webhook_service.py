...
class AudienceInboundWebhookService:
    ...
    def _maybe_enqueue_automation_send_plan(self, package: dict[str, Any], payload: dict[str, Any]) -> dict[str, Any] | None:
        ...
        from aicrm_next.extensions.growth.cloud_orchestrator.repository import build_cloud_plan_repository
        ...
        from aicrm_next.extensions.growth.cloud_orchestrator.application import ApproveCloudPlanRecipientCommand
