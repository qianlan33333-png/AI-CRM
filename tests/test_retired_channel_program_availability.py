...
def test_channel_list_does_not_expose_retired_program_availability_filter() -> None:
    source = (PROJECT_ROOT / "aicrm_next" / "automation" / "automation_engine" / "channels_api.py").read_text(encoding="utf-8")
...
def test_wecom_customer_acquisition_links_do_not_expose_retired_program_fields() -> None:
    api_source = (PROJECT_ROOT / "aicrm_next" / "automation" / "automation_engine" / "channels_api.py").read_text(encoding="utf-8")
    template_source = (
