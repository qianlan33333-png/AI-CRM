...
from aicrm_next.platform.platform_foundation.external_effects.adapters import WeComExternalContactDetailAdapter
...
from aicrm_next.platform.platform_foundation.external_effects.settlement_events import EXTERNAL_EFFECT_SETTLED_EVENT_TYPE
