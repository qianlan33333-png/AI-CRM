...
def test_repository_external_actions_are_immutable_and_trusted() -> None:
    ...
    # AI-CRM and Siyuan production promotions, Siyuan schema diagnostics,
    # runtime-config control, and the reusable production deployment workflow.
    assert workflow_count == 17
