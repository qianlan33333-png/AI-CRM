...
def test_group_ops_and_broadcast_have_one_provider_owner():
    token_broadcast = (ROOT / "aicrm_next/automation/automation_engine/group_ops/broadcast.py").read_text(encoding="utf-8")
    action_dispatcher = (ROOT / "aicrm_next/automation/automation_engine/group_ops/action_dispatcher.py").read_text(encoding="utf-8")
    broadcast_worker = (ROOT / "aicrm_next/automation/background_jobs/broadcast_queue_worker.py").read_text(encoding="utf-8")
